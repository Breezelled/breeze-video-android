...
import com.example.cby2112114536.DTO.InfoDTO.DataDTO;
 ...
 * @author breeze
 */
public class ImageTitleNumAdapter extends BannerAdapter<DataDTO, ImageTitleNumAdapter.BannerViewHolder> {

    public ImageTitleNumAdapter(List<DataDTO> mDatas) {
    ...
    //绑定数据
    @Override
    public void onBindView(BannerViewHolder holder, DataDTO data, int position, int size) {
        Glide.with(holder.imageView).load(BASE_URL + "/s3/poster/" + data.getImdbId() + ".jpg")
