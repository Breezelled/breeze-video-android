 ...
 * @author breeze
 */
public class SearchAdapter extends BaseQuickAdapter<InfoPageDTO.DataDTO.RecordsDTO, BaseViewHolder> {

    /**
     * 构造方法，此示例中，在实例化Adapter时就传入了一个List。
     * 如果后期设置数据，不需要传入初始List，直接调用 super(layoutResId); 即可
     */
    public SearchAdapter(List<InfoPageDTO.DataDTO.RecordsDTO> list) {
