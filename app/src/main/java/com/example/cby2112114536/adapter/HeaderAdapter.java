 ...
 * @author breeze
 */
public class HeaderAdapter extends BaseQuickAdapter<InfoDTO.DataDTO, BaseViewHolder> {

    /**
     * 构造方法，此示例中，在实例化Adapter时就传入了一个List。
     * 如果后期设置数据，不需要传入初始List，直接调用 super(layoutResId); 即可
     */
    public HeaderAdapter(List<InfoDTO.DataDTO> list) {
     ...
     */
    @Override
    protected void convert(@NotNull BaseViewHolder helper, @NotNull InfoDTO.DataDTO recordsDTO) {
        helper.setText(R.id.textView, recordsDTO.getName());
